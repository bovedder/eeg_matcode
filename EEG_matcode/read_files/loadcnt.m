...
% Note 2: 
% Erik Bojorges make following changes:
% isoctave varible was added, it makes possible lecture of cnt using octave
% ulong were changed to uint32
% long  were changed to int32
% in two lines different functions were used according to matlab or octave system
...
if type == 'cnt' 
      ...
      eT.size   = fread(fid,1,'uint32');
      %eT.size   = fread(fid,1,'ulong');
      eT.offset = fread(fid,1,'uint32');
      ...
      if eT.teeg==2
          ...
          if nevents > 0
              ...
              for i=1:nevents
                  ...
                  ev2(i).offset        = fread(fid,1,'int32');
